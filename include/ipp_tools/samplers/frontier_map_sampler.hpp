 ...
 *
 **********************************************************/
#ifndef SAMPLERS_FRONTIER_MAP_SAMPLER_H
#define SAMPLERS_FRONTIER_MAP_SAMPLER_H
 ...
 */
template <int N>
std::vector<Eigen::Matrix<float, N, 1>> sample_frontiers_map_random(
    ...
    std::sample(frontier_voxels.begin(), frontier_voxels.end(),
...
#endif  // SAMPLERS_FRONTIER_MAP_SAMPLER_H